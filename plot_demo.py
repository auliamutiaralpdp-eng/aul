...
st.title("Peta Interaktif Folium + Marker Cluster 🗺️✨")

# ==========================
# 1. Bikin DataFrame contoh
# ==========================

np.random.seed(42)
df = pd.DataFrame({
    "lat": -6.2 + np.random.randn(200) * 0.02,
    "lon": 106.8 + np.random.randn(200) * 0.02,
})

st.subheader("DataFrame yang dipakai")
st.dataframe(df)
...
# ==========================
st.subheader("Peta Cluster Marker (Folium)")
